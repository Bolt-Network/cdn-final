...
class UIManager {
    ...
    createControlPanelPopup() {
        ...
        option1.innerHTML = this.game.state.ventsClosed ? 
            '<span class="option-arrow" style="color: #0f0; margin-right: 1.5vw; width: 2vw;">&gt;</span><span>打开通风口</span><span id="vents-dots" style="margin-left: 1vw; direction: ltr; font-family: \'Courier New\', monospace;"></span>' :
            '<span class="option-arrow" style="color: #0f0; margin-right: 1.5vw; width: 2vw;">&gt;</span><span>关闭通风口</span><span id="vents-dots" style="margin-left: 1vw; direction: ltr; font-family: \'Courier New\', monospace;"></span>';
        ...
        option2.innerHTML = '<span class="option-arrow" style="color: transparent; margin-right: 1.5vw; width: 2vw;">&gt;</span><span>重启摄像头</span><span id="camera-dots" style="margin-left: 1vw; direction: ltr; font-family: \'Courier New\', monospace;"></span><span id="camera-status" style="margin-left: auto; padding-right: 2vw; direction: ltr;"></span>';
    ...
    selectControlOption(option) {
        ...
        if (option === 'vents') {
            ...
            if (text1) {
                text1.textContent = this.game.state.ventsClosed ? '打开通风口' : '关闭通风口';
            }
        } else {
            const arrow1 = option1.querySelector('.option-arrow');
            const arrow2 = option2.querySelector('.option-arrow');
